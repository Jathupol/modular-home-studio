-- Full schema + seed for the knockdown-house site (PostgreSQL 15+ / Supabase)
-- Generated from supabase/migrations. Run once on a fresh database.
...
insert into public.faqs (question, answer, sort_order) values
 ...
 ('ใช้เวลากี่วันในการติดตั้ง?','โดยทั่วไป 2–5 วันต่อหลัง ขึ้นอยู่กับขนาดบ้านและความพร้อมของพื้นที่',3),
